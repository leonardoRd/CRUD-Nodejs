    ...
    return (
        <div className="max-w-md w-full p-5 bg-zinc-700 rounded-md mb-3 text-center">
            ...
            <div className="flex justify-center mt-4 ">
                <button className="rounded-md bg-red-500 px-4 py-2 mx-2 hover:bg-red-400"
                onClick={() => {
                    deleteTask(task._id);
                }}>
                    Delete
                </button>
                <Link to={`/tasks/${task._id}`} className="rounded-md bg-blue-500 px-4 py-2 mx-2 hover:bg-blue-400">
                    Edit
                </Link>
            </div>            
